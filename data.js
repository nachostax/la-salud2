...
function setAIMode(mode) {
  ...
  if (elAuto && elManual) {
    // Nacho theme active colour (psh-active-n) for the selected pill,
    // psh-inactive for the other — same pattern as the person toggle.
    elAuto.className   = 'mmt-opt' + (mode==='auto'   ? ' active' : '');
    elManual.className = 'mmt-opt' + (mode==='manual' ? ' active' : '');
  }
