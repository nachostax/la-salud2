...
(function () {
  ...
  function initLogFabAnim() {
    ...
    logTab.addEventListener('click', () => {
      // Skip if we're already on the Log section. showSec() (ui.js) keeps
      // the currently-visible panel marked with the .active class on
      // #sec-log, and this listener runs in the capture phase — before
      // showSec() does anything — so the class still reflects whichever
      // section is active right now.
