...
function init() {
  load();
  if (!S.settings) S.settings = { waterGoal:{gabi:1750,nacho:1750}, stepGoal:{gabi:10000,nacho:10000}, workoutGoal:{gabi:3,nacho:3}, hypoKit:{gabi:'2 cookies (~12.5g sugar)',nacho:''}, hypoMacros:{gabi:{calories:50,carbs_g:13}} };
