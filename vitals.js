...
function renderVitals() {
  ...
  // ── macro donut (moved here from the Progress tab — see renderProgress) ──
  ...
  const heroHtml = `
    <div class="day-card">
      <div class="day-card-hdr">
        <div class="day-card-name"><div class="dot" style="background:${color}"></div></div>
        ${isToday ? `<div class="status-tag ${todayFull?'tag-complete':(meals.length?'tag-incomplete':'tag-neutral')}">
...
// The macro donut now lives in Vitals (see renderVitals above) — Progress is
// just the trends & evolution view, always expanded, no toggle.
