...
function renderVitals() {
  ...
  document.getElementById('vitals-body').innerHTML = '<div class="psh-date" id="hdr-date"></div>' + renderPotatesHero() + caloriesMicroHtml + wkHtml + waterHtml + renderLowsPanel(person, todayStr());
