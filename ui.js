...
const SEC_ORDER = ['vitals','kitchen','workout','log','mission','history'];
...
function showSec(name, el) {
  ...
  const _titleLabels = { vitals:'Vitals', log:'Log', kitchen:'Kitchen', workout:'Workout', mission:'Mission', history:'History', settings:'Settings' };
...
(function initSwipeNav() {
  ...
  function _updateIndicatorForDrag(dx) {
    ...
    const _titleLabels = { vitals:'Vitals', log:'Log', kitchen:'Kitchen', workout:'Workout', mission:'Mission', history:'History' };
    const titleEl = document.getElementById('hdr-section-title');
    if (titleEl && toTab) {
