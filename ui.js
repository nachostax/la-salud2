...
const SEC_ORDER = ['vitals','kitchen','workout','log','history'];
...
function showSec(name, el) {
  ...
  const _titleLabels = { vitals:'Vitals', log:'Log', kitchen:'Kitchen', workout:'Workout', history:'History', settings:'Settings' };
...
(function initSwipeNav() {
  ...
  function _updateIndicatorForDrag(dx) {
    ...
    const _titleLabels = { vitals:'Vitals', log:'Log', kitchen:'Kitchen', workout:'Workout', history:'History' };
    const titleEl = document.getElementById('hdr-section-title');
    if (titleEl && toTab) {
