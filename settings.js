  ...
  el.innerHTML = allDates.map(date => {
    ...
    const detail = summaries.map(s => {
      ...
      const mealLines = s.meals.map(e => {
        ...
        return `<div style="display:flex;justify-content:space-between;align-items:baseline;padding:3px 0;border-bottom:1px solid var(--bark)" onclick="openEntryDetail(${e.id})">
