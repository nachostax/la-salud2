  ...
  el.innerHTML = allDates.map(date => {
    ...
    return `<div class="day-card hist-day-card">
      <div class="hist-day-hdr">
        <span class="hist-day-date" style="cursor:pointer" onclick="openDayDetail('${p}','${date}')">${displayDate}</span>
        <span class="hday-arr" style="font-size:11px;color:var(--mist);cursor:pointer" id="${id}-arr" onclick="toggleHistoryDay('${id}')">▸</span>
      </div>
