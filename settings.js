...
function renderTrends() {
  ...
  // ── WEIGHT CHART ──
  {
    ...
    html += `<div class="trend-card">
      <div class="trend-card-title ${themeClass}">Weight evolution</div>
  ...
  // ── CALORIE TREND (last 30 days, complete days only) ──
  {
    ...
    html += `<div class="trend-card">
      <div class="trend-card-title ${themeClass}">Calorie trend (complete days)</div>
      <div class="mini-chart">${svg}</div>
      <div class="chart-labels"><span>${labels[0]}</span><span>${labels[1]}</span></div>
      <div class="trend-stat-row">
        <div class="trend-stat">
  ...
  // ── PROTEIN TREND ──
  {
    ...
    html += `<div class="trend-card">
      <div class="trend-card-title ${themeClass}">Protein trend</div>
      <div class="mini-chart">${svg}</div>
      <div class="chart-labels"><span>${labels[0]}</span><span>${labels[1]}</span></div>
      <div class="trend-stat-row">
        <div class="trend-stat">
  ...
  // ── WATER TREND ──
  {
    ...
    html += `<div class="trend-card">
      <div class="trend-card-title ${themeClass}">Water trend</div>
      <div class="mini-chart">${svg}</div>
      <div class="chart-labels"><span>${labels[0]}</span><span>${labels[1]}</span></div>
      <div class="trend-stat-row">
  ...
  el.innerHTML = allDates.map(date => {
    ...
    const detail = summaries.map(s => {
      ...
      const workoutLines = s.workouts.map(e => {
        ...
        return `<div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid var(--bark)">
