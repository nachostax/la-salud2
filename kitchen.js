  ...
  const renderFn = () => {
    ...
    inner.innerHTML = `
      ...
      <div style="padding:18px 16px 0">
        <div style="font-family:'Playfair Display',serif;font-size:26px;color:var(--bone);line-height:1.15">${m.name}</div>
      ...
      <div style="padding:14px 16px 0">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:2px;color:var(--mist);text-transform:uppercase;margin-bottom:8px">Ingredients</div>
