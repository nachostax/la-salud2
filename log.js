...
// The retro-date toggle/clear functions live in data.js (not in scope here)
// and only know about meal/workout retro-logging. Wrapped here so opening/
// closing the retro-date row also shows/hides and pre-fills the water block
// underneath, without data.js needing to know it exists. Safe to call
// multiple times — only wraps once, guarded by window.__retroWaterWrapped.
